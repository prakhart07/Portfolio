        ...
        <div className="container">
              ...
              <div className="half">
                    ...
                    <p>Hello! I'm Prakhar, a dedicated software developer with a passion for crafting efficient and innovative solutions to complex problems. I thrive in the world of code and enjoy turning ideas into reality.</p>
                            ...
                            {/* With [X years/months] of experience in the software development industry, */}<p>I've had the opportunity to work on a variety of projects, ranging from web pages and web applications to backend systems. My expertise includes HTML & CSS,JS,React.JS,J2E,.NET,MySQL,DevOps,Git etc, and I'm always eager to embrace new challenges and technologies.</p> 
